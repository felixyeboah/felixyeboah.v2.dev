...
<Info>
Before getting started, make sure you have a basic understanding of Remix. If you are new to Remix, check out the [official documentation](https://docs.remix.run/) and [egghead course](https://egghead.io/playlists/getting-started-with-remix-2d2e) to get up to speed.
</Info>
